...
const ITEMS_ZH_DIR = path.join(DOCS_DATA_DIR, 'items');
const ITEMS_EN_DIR = path.join(DOCS_DATA_DIR, 'items-en');

const INDEX_ZH_FILE = path.join(DOCS_DATA_DIR, 'MAINTENANCE_INDEX.md');
const INDEX_EN_FILE = path.join(DOCS_DATA_DIR, 'MAINTENANCE_INDEX_EN.md');
